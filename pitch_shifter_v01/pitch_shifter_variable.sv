...
//////////////////////////////////////////
      ...
      case (state)
        ...
        SM_GET_LFO_INDEX : begin
          ...
          if (dds_dout_mult_valid == 1) begin
            ...
            //lfo_index <= dds_dout_mult[C_PROG_DDS_DWIDTH+G_BUFFER_ADDR_WIDTH-1 -: G_BUFFER_ADDR_WIDTH];
        ...
        SM_GET_RD_INDEX0_1 : begin
          ...
          if (bram_din_wr_addr+lfo_index >= 2**prog_buf_depthlog2) begin
            rd_index0 <= bram_din_wr_addr+lfo_index-2**prog_buf_depthlog2;
          end
          else begin
            rd_index0 <= bram_din_wr_addr+lfo_index;
          end

          if (bram_din_wr_addr+lfo_index+1 >= 2**prog_buf_depthlog2) begin
            rd_index1 <= bram_din_wr_addr+lfo_index+1-2**prog_buf_depthlog2;
          end
          else begin
        ...
        SM_SEND_OUTPUT : begin
          if (dout_valid_int & dout_ready == 1) begin
            dout_valid_int    <= 0;
            din_ready_int     <= 1;
            if (bram_din_wr_addr+1 >= 2**prog_buf_depthlog2) begin
              bram_din_wr_addr  <= 0;
            end
            else begin
              bram_din_wr_addr  <= bram_din_wr_addr + 1;
  ...
  assign window_index1 = ((lfo_index + 1) >= 2**prog_buf_depthlog2) ? 0 : (lfo_index + 1);
